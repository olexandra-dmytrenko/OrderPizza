...
//                new String[]{"appContext.xml"}, appContextParent);
    ...
    @Test
    public void testCustomerDefaultPromocard() {
        assertEquals(customer.getPromoCard().toString(), "PromoCard{id=1, amount=0.0, blockedAmount=0.0}");
//customer.getPromoCard()
    }
